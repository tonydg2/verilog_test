...
//Command     : generate_target axi_interconnect_ip_wrapper.bd
//Design      : axi_interconnect_ip_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module axi_interconnect_ip_wrapper
   (ACLK_0,
    ARESETN_0,
    M00_ACLK_0,
    M00_ARESETN_0,
  ...
  axi_interconnect_ip axi_interconnect_ip_i
       (.ACLK_0(ACLK_0),
        .ARESETN_0(ARESETN_0),
