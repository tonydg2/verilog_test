...
vlog -work xpm -64 -incr -mfcu -sv -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_10 "+incdir+../../../../project_1.gen/sources_1/ip/axi_crossbar_0/hdl" "+incdir+/media/adg/inland_sata6/ubuntu_installs/xilinx/Vivado/2021.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr -mfcu "+incdir+../../../../project_1.gen/sources_1/ip/axi_crossbar_0/hdl" "+incdir+/media/adg/inland_sata6/ubuntu_installs/xilinx/Vivado/2021.1/data/xilinx_vip/include" \
"../../../../project_1.gen/sources_1/ip/axi_crossbar_0/axi_crossbar_0_sim_netlist.v" \
