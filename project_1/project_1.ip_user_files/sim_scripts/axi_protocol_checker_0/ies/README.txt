...
#
# Generated by export_simulation on Sun Aug 22 20:45:25 EDT 2021
#
################################################################################
...
'-reset_run' switch to the './axi_protocol_checker_0.sh' script.

./axi_protocol_checker_0.sh -reset_run
...
./axi_protocol_checker_0.sh -noclean_files

For more information on the script, please type './axi_protocol_checker_0.sh -help'.
