...
#
# Generated by Vivado on Wed Sep 08 11:51:22 EDT 2021
...
# executing this script. Please type 'uart_bd.sh -help' for more information.
#
...
# Script info
echo -e "uart_bd.sh - Script generated by export_simulation (Vivado v2021.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/media/adg/inland_sata6/ubuntu_installs/xilinx/Vivado/2021.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/media/adg/inland_sata6/ubuntu_installs/xilinx/Vivado/2021.1/data/xilinx_vip/include" \
    "$ref_dir//home/adg/GitHub/verilog_test/project_1/project_1.gen/sources_1/bd/uart_bd/ip/uart_bd_axi_uartlite_0_0/uart_bd_axi_uartlite_0_0_sim_netlist.v" \
    "$ref_dir//home/adg/GitHub/verilog_test/project_1/project_1.gen/sources_1/bd/uart_bd/ip/uart_bd_axi_uartlite_0_1/uart_bd_axi_uartlite_0_1_sim_netlist.v" \
    "$ref_dir/../../../bd/uart_bd/sim/uart_bd.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.uart_bd xil_defaultlib.glbl -o uart_bd_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./uart_bd_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key uart_bd_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc uart_bd_simv.daidir)
