...
# Set xvlog options
xvlog_opts="--incr --relax -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_10 -L axi_vip_v1_1_10 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uart_bd xil_defaultlib.uart_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uart_bd -key {Behavioral:sim_1:Functional:uart_bd} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_a4e3.protoinst" -protoinst "protoinst_files/smartconect_ip.protoinst" -protoinst "protoinst_files/axi_interconnect_ip.protoinst" -protoinst "protoinst_files/iic_bd.protoinst" -protoinst "protoinst_files/uart_bd.protoinst" -log simulate.log
}
